...
class AppTheme {
  ...
  static ThemeData get light {
    const scheme = ColorScheme(
      ...
      secondaryContainer: Color(0xFFE0EEFB),
      onSecondaryContainer: Color(0xFF1A3A5C),
      tertiary: AppColors.lightAccent,
      onTertiary: Colors.white,
      tertiaryContainer: Color(0xFFD4EAFC),
  ...
  static ThemeData get dark {
    const scheme = ColorScheme(
      ...
      primaryContainer: Color(0xFF1E4270),
      onPrimaryContainer: Color(0xFFCADFFF),
      secondary: AppColors.darkSecondary,
      onSecondary: Color(0xFF002D5E),
      secondaryContainer: Color(0xFF1E4270),
      onSecondaryContainer: Color(0xFFD2E4FF),
      tertiary: AppColors.darkAccent,
      onTertiary: Color(0xFF002D5E),
      tertiaryContainer: AppColors.darkSecondarySurface,
