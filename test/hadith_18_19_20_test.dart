...
void main() {
  ...
  group('HadithRepository H18-20', () {
    test('Repository memuatkan H1-H42 (42 hadis)', () async {
      ...
      expect(repository.byNumber(21), isNotNull);
      expect(repository.byNumber(22), isNotNull);
      ...
      expect(repository.byNumber(42), isNotNull);
    });
